...
let issue = false
function switch1() {
    let content = '<form class="formStyling" id="myForm"> <!--First form --> <div class="container"> <div class="row"> <div class="col-12 col-md-4" style="margin-top: 3px;"> <label>Name: </label> </div> <div class="col-12 col-md-8"> <input type="text" name="name" id="name"><span id="nameMsg" class="redText" ></span> </div> </div> <br> <div class="row"> <div class="col-12 col-md-4"> <label>Email: </label> </div> <div class="col-12 col-md-8"> <input type="email" name="email" id="email"> <span id="emailMsg" class="redText"></span> </div> </div> <br> <div class="row"> <div class="col-12 col-md-4"> <label>Password: </label> </div> <div class="col-12 col-md-8"> <input type="password" id="pas1"> <span id="pas1Msg" class="redText"></span> </div> </div> <br> <div class="row"> <div class="col-12 col-md-4"> <label>Re-enter Password: </label> </div> <div class="col-12 col-md-8"> <input type="password" id="pas2"> <span id="pas2Msg" class="redText"></span> </div> </div> <br> <div class="row"> <div class="col"> <label>Show Password: &nbsp;<input type="checkbox" onclick="togglePassword()"></label> </div> </div> </div> <br> <input type="button" class="btn btn-primary" value="Create Account" onclick="validateAccount()"> <span id="validationMsg"></span> <br> <br> <p id="self">By clicking on "Create Account", you agree to the <a href="#self">terms and conditions</a> of this website.</p>'
...
function validateShipping() {
    ...
    {
        document.getElementById('shipMsg').innerHTML = "Please choose a shipping option"
    }
